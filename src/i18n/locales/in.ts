...
export default {
  ...
  "status": {
    ...
    "playlistSavedWithSkipped": "Playlist disimpan; {{count}} trek yang tidak dapat diputar dilewati.",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-external-media": { "title": "Media eksternal", "description": "Buka pengaturan backend pemutaran web Apple Music" },
      "external-media-toggle": { "title": "Backend media eksternal", "description": "Nyalakan atau matikan backend pemutaran web Apple Music" },
      "external-media-regenerate-token": { "title": "Buat ulang token ekstensi", "description": "Buat token baru ekstensi Folia untuk Chrome (memutus koneksi ekstensi)" },
      ...
      "transition-beat-cpu-toggle": { "title": "Deteksi beat pakai CPU", "description": "Analisis beat dijalankan di prosesor supaya kartu grafis bebas untuk game" },
      ...
      "home-appleMusic": { "title": "Buka Apple Music", "description": "Buka tab beranda Apple Music" },
      ...
      "grid-export-playlist": { "title": "Ekspor daftar putar ini", "description": "Simpan daftar putar lokal sebagai berkas m3u8, atau json portabel jika mencampur sumber" },
      "grid-import-playlist": { "title": "Impor berkas daftar putar", "description": "Buat daftar putar dari berkas m3u8 atau json portabel" },
  ...
  "options": {
    ...
    "transitionBeatThisCpu": "Deteksi beat di CPU",
    "transitionBeatThisCpuDesc": "Analisis beat dijalankan di prosesor supaya kartu grafis utuh untuk game. Analisis beat jadi sedikit lebih lambat.",
    ...
    "externalMediaSettings": "Media eksternal",
    "externalMediaSettingsDesc": "Putar lagu lengkap melalui music.apple.com di Chrome (ekstensi Folia untuk Chrome)",
    "externalMediaSection": "Backend media eksternal",
    "externalMediaEnable": "Aktifkan media eksternal",
    "externalMediaEnableDesc": "Secara bawaan mati. Perlu Chrome berjalan, ekstensi Folia terpasang, tab music.apple.com masuk, dan langganan aktif.",
    "externalMediaStatus": "Status koneksi",
    "externalMediaDisabled": "Nonaktif (aktifkan di atas)",
    "externalMediaEnabledStatus": "Media eksternal diaktifkan",
    "externalMediaDisabledStatus": "Media eksternal dinonaktifkan",
    "externalMediaPort": "Alamat loopback",
    "externalMediaTokenLabel": "Token ekstensi",
    "externalMediaTokenMissing": "Belum dihasilkan",
    "externalMediaToken": "Pemasangan ekstensi",
    "externalMediaCopy": "Salin Token",
    "externalMediaCopied": "Tersalin",
    "externalMediaRegenerate": "Buat Ulang Token",
    "externalMediaRegenerateConfirm": "Membuat ulang token akan langsung memutus koneksi ekstensi Folia untuk Chrome. Lanjutkan?",
    "externalMediaTokenRotated": "Token baru dibuat. Tempelkan ke ekstensi Folia untuk Chrome agar tersambung kembali.",
  ...
  "appleMusic": {
    ...
    "signInPrompt": "Masuk untuk menelusuri playlist dan album Apple Music Anda.",
    "desktopOnly": "Pustaka Apple Music hanya tersedia di aplikasi desktop.",
    "playlistsTitle": "Playlist · {{count}} lagu",
    "noPlaylists": "Belum ada playlist di pustaka Anda.",
    "noAlbums": "Belum ada album di pustaka Anda.",
    "playFullTrack": "Putar lagu lengkap di Apple Music",
    "extensionMissing": "Pasang ekstensi Folia untuk Chrome",
    "tabNotFound": "Buka music.apple.com di Chrome",
    "notSignedIn": "Masuk ke Apple Music di Chrome",
    "storefrontMismatch": "Region Apple Music di Chrome tidak cocok",
    "playerNotReady": "Muat ulang tab music.apple.com",
    "noCatalogEntry": "Lagu ini tidak punya entri katalog Apple Music, jadi tidak bisa diputar.",
    "playRequestFailed": "Tidak bisa memulai pemutaran di Chrome. Periksa ekstensi dan tab Apple Music.",
    "extensionHint": "Folia memutar lagu lengkap melalui music.apple.com di Chrome. Pasang ekstensi Folia, biarkan tab music.apple.com terbuka, dan masuk dengan langganan aktif.",
    "queueTakenOver": "Pemutaran sekarang dikontrol oleh pemutar web Apple Music; antrean Folia berhenti maju"
  },
  "navidrome": {
    "title": "Navi",
  ...
  "ponder": {
    ...
    "captions": {
      ...
      "sidePanel": {
        ...
        "sourceLyrics": "Dua ikon kecil di kanan baris lirik: satu mengimpor berkas lirik lokal (lrc / vtt / ttml / qrc / yrc / krc / txt), satu mencocokkan secara daring. Strip di bawahnya menyebut mana yang sedang dipakai; setelah kamu mengimpor, muncul kotak kedua untuk beralih kembali.",
