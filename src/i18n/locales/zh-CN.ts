...
export default {
  ...
  "status": {
    ...
    "playlistSavedWithSkipped": "歌单已保存，跳过 {{count}} 首不可回放的曲目。",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-external-media": { "title": "外部媒体", "description": "打开 Apple Music 网页播放后端设置" },
      "external-media-toggle": { "title": "外部媒体后端", "description": "开启或关闭 Apple Music 网页播放后端" },
      "external-media-regenerate-token": { "title": "重置扩展令牌", "description": "生成新的 Folia Chrome 扩展令牌（会断开扩展连接）" },
      ...
      "transition-beat-cpu-toggle": { "title": "节拍检测用 CPU", "description": "节拍分析跑在处理器上，显卡完整留给游戏" },
      ...
      "home-appleMusic": { "title": "打开 Apple Music", "description": "打开 Apple Music 首页 tab" },
      ...
      "grid-export-playlist": { "title": "导出此歌单", "description": "本地歌单保存为 m3u8，跨来源歌单保存为便携 json" },
      "grid-import-playlist": { "title": "导入歌单文件", "description": "从 m3u8 或便携 json 文件创建歌单" },
  ...
  "options": {
    ...
    "transitionBeatThisCpu": "节拍检测用 CPU",
    "transitionBeatThisCpuDesc": "节拍分析跑在处理器上，显卡完整留给游戏。节拍分析会稍慢一些。",
    "modelsTitle": "分析模型",
    ...
    "externalMediaSettings": "外部媒体",
    "externalMediaSettingsDesc": "通过 Chrome 里的 music.apple.com 播放全曲（Folia Chrome 扩展）",
    "externalMediaSection": "外部媒体后端",
    "externalMediaEnable": "启用外部媒体",
    "externalMediaEnableDesc": "默认关闭。需要 Chrome 在运行、已装 Folia 扩展、music.apple.com 标签页已登录且有有效订阅。",
    "externalMediaStatus": "连接状态",
    "externalMediaDisabled": "已关闭（在上方开启）",
    "externalMediaEnabledStatus": "外部媒体已启用",
    "externalMediaDisabledStatus": "外部媒体已关闭",
    "externalMediaPort": "本地地址",
    "externalMediaTokenLabel": "扩展令牌",
    "externalMediaTokenMissing": "尚未生成",
    "externalMediaToken": "扩展配对",
    "externalMediaCopy": "复制令牌",
    "externalMediaCopied": "已复制",
    "externalMediaRegenerate": "重置令牌",
    "externalMediaRegenerateConfirm": "重置会生成新令牌并立即断开 Folia Chrome 扩展的连接。继续吗？",
    "externalMediaTokenRotated": "已生成新令牌。请把它填入 Folia Chrome 扩展以重新连接。",
  ...
  "appleMusic": {
    ...
    "signInPrompt": "登录后即可浏览你的 Apple Music 资料库歌单与专辑。",
    "desktopOnly": "Apple Music 资料库仅在桌面版可用。",
    "playlistsTitle": "歌单 · {{count}} 首",
    "noPlaylists": "资料库里还没有歌单。",
    "noAlbums": "资料库里还没有专辑。",
    "playFullTrack": "在 Apple Music 中播放全曲",
    "extensionMissing": "请安装 Folia Chrome 扩展",
    "tabNotFound": "请在 Chrome 中打开 music.apple.com",
    "notSignedIn": "请在 Chrome 中登录 Apple Music",
    "storefrontMismatch": "Chrome 中 Apple Music 区域不一致",
    "playerNotReady": "请刷新 music.apple.com 标签页",
    "noCatalogEntry": "这首曲目没有 Apple Music 目录条目，无法播放。",
    "playRequestFailed": "无法在 Chrome 中开始播放，请检查扩展与 Apple Music 标签页。",
    "extensionHint": "Folia 通过 Chrome 里的 music.apple.com 播放全曲。请安装 Folia 扩展、保持 music.apple.com 标签页打开，并登录有效的订阅账号。",
    "queueTakenOver": "已由 Apple Music 网页版接管播放，Folia 队列暂停推进"
  },
  "navidrome": {
    "title": "Navi",
