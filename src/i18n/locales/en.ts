...
export default {
  ...
  "status": {
    ...
    "playlistSavedWithSkipped": "Playlist saved; skipped {{count}} unplayable track(s).",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-external-media": { "title": "External media", "description": "Open the Apple Music web playback backend settings" },
      "external-media-toggle": { "title": "External media backend", "description": "Turn the Apple Music web playback backend on or off" },
      "external-media-regenerate-token": { "title": "Regenerate extension token", "description": "Issue a new Folia Chrome extension token (drops the extension connection)" },
      ...
      "transition-beat-cpu-toggle": { "title": "Beat grid on CPU", "description": "Run beat detection on the processor so the graphics card stays free for games" },
      ...
      "home-appleMusic": { "title": "Open Apple Music", "description": "Open the Apple Music home tab" },
      ...
      "grid-export-playlist": { "title": "Export this playlist", "description": "Save this playlist as an m3u8 file, or as portable json when it mixes sources" },
      "grid-import-playlist": { "title": "Import a playlist file", "description": "Create a playlist from an m3u8 or portable json file" },
  ...
  "options": {
    ...
    "transitionBeatThisCpu": "Beat grid on CPU",
    "transitionBeatThisCpuDesc": "Runs beat detection on the processor so games keep the whole graphics card. Beat analysis gets a little slower.",
    ...
    "externalMediaSettings": "External media",
    "externalMediaSettingsDesc": "Play full tracks through music.apple.com in Chrome (Folia Chrome extension)",
    "externalMediaSection": "External media backend",
    "externalMediaEnable": "Enable external media",
    "externalMediaEnableDesc": "Off by default. Requires Chrome running, the Folia extension, a signed-in music.apple.com tab, and an active subscription.",
    "externalMediaStatus": "Connection status",
    "externalMediaDisabled": "Disabled (turn it on above)",
    "externalMediaEnabledStatus": "External media enabled",
    "externalMediaDisabledStatus": "External media disabled",
    "externalMediaPort": "Loopback address",
    "externalMediaTokenLabel": "Extension token",
    "externalMediaTokenMissing": "Not generated",
    "externalMediaToken": "Extension pairing",
    "externalMediaCopy": "Copy Token",
    "externalMediaCopied": "Copied",
    "externalMediaRegenerate": "Regenerate Token",
    "externalMediaRegenerateConfirm": "Regenerating issues a new token and immediately disconnects the Folia Chrome extension. Continue?",
    "externalMediaTokenRotated": "New token issued. Paste it into the Folia Chrome extension to reconnect.",
  ...
  "appleMusic": {
    ...
    "signInPrompt": "Sign in to browse your Apple Music playlists and albums.",
    "desktopOnly": "The Apple Music library is available in the desktop app only.",
    "playlistsTitle": "Playlists · {{count}} songs",
    "noPlaylists": "No playlists in your library yet.",
    "noAlbums": "No albums in your library yet.",
    "playFullTrack": "Play the full track in Apple Music",
    "extensionMissing": "Install the Folia Chrome extension",
    "tabNotFound": "Open music.apple.com in Chrome",
    "notSignedIn": "Sign in to Apple Music in Chrome",
    "storefrontMismatch": "Apple Music region mismatch in Chrome",
    "playerNotReady": "Reload the music.apple.com tab",
    "noCatalogEntry": "This track has no Apple Music catalog entry, so it cannot be played.",
    "playRequestFailed": "Could not start playback in Chrome. Check the extension and the Apple Music tab.",
    "extensionHint": "Folia plays full tracks through music.apple.com in Chrome. Install the Folia extension, keep a music.apple.com tab open, and sign in with an active subscription.",
    "queueTakenOver": "Playback is now controlled by the Apple Music web player; Folia's queue has stopped advancing"
  },
  "navidrome": {
    "title": "Navi",
  ...
  "ponder": {
    ...
    "captions": {
      ...
      "sidePanel": {
        ...
        "sourceLyrics": "Two small icons at the right of the lyrics row: one imports a local lyric file (lrc / vtt / ttml / qrc / yrc / krc / txt), one goes and matches online. The strip below says which one is in use; once you have imported, a second cell appears to switch back.",
